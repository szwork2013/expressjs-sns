;(function($) {
    ...
    if ($.isFunction(options)) {
        ...
        function init() {
			...
			popups = ($w.data('bPopup') || 0) + 1, id = prefix + popups,fixedVPos = o.position[1] !== 'auto', fixedHPos = o.position[0] !== 'auto', fixedPosStyle = o.positionStyle === 'fixed', height = $popup.outerHeight(true), width = $popup.outerWidth(true);
        ...
        function bindEvents() {
            ...
            if (o.modalClose) {
                $('.p-mask.'+id).css('cursor', 'pointer').bind('click', close);
            }
            if (o.escClose) {
