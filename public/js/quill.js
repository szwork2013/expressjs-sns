...
ImageTooltip = (function(_super) {
  ...
  ImageTooltip.DEFAULTS = {
    ...
    template: '<input class="input" type="textbox"> <div class="preview"> <span>预览</span> </div> <a href="javascript:;" class="cancel">取消</a> <a href="javascript:;" class="insert">插入</a>'
  };
...
LinkTooltip = (function(_super) {
  ...
  LinkTooltip.DEFAULTS = {
    ...
    template: '<span class="title">链接地址:&nbsp;</span> <a href="#" class="url" target="_blank" href="about:blank"></a> <input class="input" type="text"> <span>&nbsp;&#45;&nbsp;</span> <a href="javascript:;" class="change">确定</a> <a href="javascript:;" class="done">确定</a>'
  };
